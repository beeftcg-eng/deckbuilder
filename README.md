...
- Each card is listed once, under the first set the data gives for it, so the Sets tab holds only the cards filed under a set; alternate artworks aren't listed separately. Tokens and Skill Cards are left out.
