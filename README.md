...
- **Yu-Gi-Oh! artworks**: cards with several official artworks show a **🎨 N arts** badge; open it and pick the one on your copy, and that printing shows it everywhere. (The card data doesn't say which printing uses which art, so it can't be automatic.)
