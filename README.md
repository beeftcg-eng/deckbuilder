...
- **Binders**: **Move…** on a binder row moves copies to another binder or into a deck of that game (they leave the binder; your collection doesn't change).
- **Yu-Gi-Oh! artworks**: the card details show every official artwork of a card; pick the one on your copy and that printing shows it everywhere. (The card data doesn't say which printing uses which art.)
